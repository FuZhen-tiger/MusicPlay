<template>
    ...
    <div class="top-wrap">
      ...
      <div class="info-wrap">
        ...
        <div class="play-wrap">
          <span class="iconfont iconcircle-play"></span>
              ...
              <td>
                <div class="song-wrap">
                  <div class="name-wrap">
                    ...
                    <span>{{ item.name }}</span>
                    <!-- mv图标 -->
                    <span v-if="item.mv !== 0" class="iconfont iconbofangMV" @click="toMv(item.mv)"></span>
                  </div>
                </div>
              </td>
...
export default {
    ...
    methods:{
        ...
        async getPlaylistDetail() { 
            const res=await this.$http.post('/playlist/detail',{id:this.id,n:100000})
        ...
        async getPlaylistComments(){
            const res=await this.$http.post('/comment/playlist',{
                id:this.id,
                limit:this.pageSize,
